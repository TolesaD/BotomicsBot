// start-railway.js - HARDCODED FOR BOT TESTING
console.log('🚀 MarCreatorBot - HARDCODED TESTING MODE');
console.log('==========================================');
console.log('🔧 USING HARDCODED VALUES TO TEST BOT STARTUP');
...
// Wait for test to complete before starting app
(async () => {
  await testTelegramConnection();
  
  console.log('🏃 Starting main application from src/app.js...');
