...
ProductCatalog.belongsTo(Bot, {
  foreignKey: "bot_id",
  as: "ProductBot",
});

Bot.hasMany(ProductCatalog, {
  foreignKey: "bot_id",
  as: "Products",
});

ProductOrder.belongsTo(Bot, {
  foreignKey: "bot_id",
  as: "OrderBot",
});

ProductOrder.belongsTo(ProductCatalog, {
...
Bot.hasMany(ProductOrder, {
  foreignKey: "bot_id",
  as: "Orders",
});

ProductCatalog.hasMany(ProductOrder, {
  foreignKey: "product_id",
  as: "Orders",
});
